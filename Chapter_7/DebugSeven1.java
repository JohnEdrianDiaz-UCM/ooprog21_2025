...
public class DebugSeven1 {
    public static void main(String[] args) {
        ...
        compareNames(name1, name2, name3);
        compareNames(name1, name3, name2);
        compareNames(name2, name3, name1);
    }

    public static void compareNames(String n1, String n2, String n3) {
